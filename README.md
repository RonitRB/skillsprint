# SkillSprint — Placement Preparation Portal

A full-stack MERN application for placement test practice (timed quizzes, admin CRUD, result history). Built and customized by **Ronit RB** for the Isaii assignment.
